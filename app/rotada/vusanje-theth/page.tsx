          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl p-6 border border-blue-100">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg mb-2 text-gray-900">Zorluk ve Alternatifler</h3>
                      <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="grid md:grid-cols-2 gap-2 font-mono text-xs">
                <p>WP 1: <a href="https://www.google.com/maps/search/?api=1&query=42.85432,19.80234" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">34T425670 4743180</a>, 970m - Vusanje başlangıç</p>
                <p>WP 2: <a href="https://www.google.com/maps/search/?api=1&query=42.84123,19.78456" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">34T423890 4741730</a>, 1250m - Orman sınırı</p>
                <p>WP 3: <a href="https://www.google.com/maps/search/?api=1&query=42.82987,19.76543" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">34T421980 4740470</a>, 1680m - Açık arazi</p>
                <p>WP 4: <a href="https://www.google.com/maps/search/?api=1&query=42.81234,19.74321" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">34T419870 4738530</a>, 2040m - Peja Geçidi</p>
                <p>WP 5: <a href="https://www.google.com/maps/search/?api=1&query=42.79876,19.72345" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">34T417980 4737020</a>, 1750m - İniş başlangıcı</p>
                <p>WP 6: <a href="https://www.google.com/maps/search/?api=1&query=42.38456,19.70123" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">34T415870 4735210</a>, 1350m - Orman girişi</p>
                <p>WP 7: <a href="https://www.google.com/maps/search/?api=1&query=42.36543,19.68765" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">34T414230 4733090</a>, 1050m - Su kaynağı</p>
                <p>WP 8: <a href="https://www.google.com/maps/search/?api=1&query=42.34321,19.67234" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">34T412560 4730620</a>, 850m - Theth yaklaşımı</p>
                <p>WP 9: <a href="https://www.google.com/maps/search/?api=1&query=42.39795,19.77452" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">34T398793 4695067</a>, 745m - Theth merkez</p>
              </div>
            </div>
